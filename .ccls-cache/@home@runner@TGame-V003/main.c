...
strcpy(go_locate, user_command + 5);
  ...
  else if (strcmp(user_command, "mine")==0||strcmp(user_command, "채굴")==0){

    if(strcmp(player.location, "메인-생산-1")==0){
      printf("success\n");
    }else{
      printm1l("해당 명령어는 생산 1구역의 특수 명명어 입니다.");
    }
